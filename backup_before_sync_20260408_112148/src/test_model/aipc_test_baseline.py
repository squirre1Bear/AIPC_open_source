...
def main():
    ...
    data_path_list = sorted(os.path.join(args.parquet_dir, f) for f in os.listdir(args.parquet_dir) if f.endswith(".parquet"))
...
if __name__ == "__main__":
  ...
  #    --model_path ./model/best_full_aux_20260407_v1/best.pt ^
  #    --parquet_dir "E:\AIPC_dataset\bas_test_dataset" ^
  #    --config ./model.yaml ^
  #    --out_path ./run/basic_test_outputs ^
