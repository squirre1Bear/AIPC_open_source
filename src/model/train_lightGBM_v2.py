# python src/model/train_lightGBM_v2.py   --data-root /root/autodl-tmp/datasets/aipc   --v1-model-dir ~/aipc/models/lgbm_v1   --out-dir ~/aipc/models/lgbm_v2   --train-max-rows 3000000   --valid-max-rows 1000000    --max-rows-per-file 40000

# python src/model/train_lightGBM_v2.py \
#   --data-root /root/autodl-tmp/datasets/aipc_oof \
#   --v1-model-dir /root/aipc/models/lgbm_v1_oof \
#   --out-dir /root/aipc/models/lgbm_v2_oof \
